  ...
  function drawTable(data) {
    if (Object.keys(data).length > 0){
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            var id = data[i].id;
            tableRowContent = tableRowContent + "<td><button class='hubBtn' type='button' onclick='hubBtnPrsd("+id+", "+name+")'><img src='../pictures/home.ico' class='hubBtnImg'><br>"+name+"</button></td>";
            if(count == 3){
              //Go to new row
